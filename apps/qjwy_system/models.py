...
class Users(AbstractUser, CoreModel):
    ...
    def set_password(self, raw_password):
        ...
        super().set_password(raw_password)  # 先不进行额外加密
...
def media_img_name(instance, filename):
    ...
    return os.path.join('imgs', h[0:1], h[1:2], h + ext.lower())
...
class ImgList(CoreModel):
    ...
    fileSize = models.CharField(max_length=50, null=True, blank=True, verbose_name='文件大小', help_text='文件大小')
    fileType = models.CharField(max_length=50, null=True, blank=True, verbose_name='文件类型', help_text='文件类型')
    fileClassify = models.CharField(max_length=50, null=True, blank=True, verbose_name='文件分类', help_text='文件分类')
    extend = models.CharField(max_length=50, null=True, blank=True, verbose_name='拓展字段', help_text='拓展字段')
...
class FileList(CoreModel):
    ...
    md5sum = models.CharField(max_length=36, blank=True, verbose_name="文件md5", help_text="文件md5")
    fileSize = models.CharField(max_length=50, null=True, blank=True, verbose_name='文件类型', help_text='文件类型')
    fileType = models.CharField(max_length=50, null=True, blank=True, verbose_name='文件类型', help_text='文件类型')
    fileClassify = models.CharField(max_length=50, null=True, blank=True, verbose_name='文件分类', help_text='文件分类')
    extend = models.CharField(max_length=50, null=True, blank=True, verbose_name='拓展字段', help_text='拓展字段')
